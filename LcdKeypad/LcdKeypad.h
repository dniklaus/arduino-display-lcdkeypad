...
public:
  ...
  LcdKeypad(MCPType mcptype, uint8_t i2cAddr, LcdDeviceType lcdDeviceType,
            uint8_t detectDevice = 0, uint8_t backlightInverted = 0);

  LcdKeypad(LcdDeviceType lcdDeviceType,
            int  lcdRSPin              = s_defaultLcdRSPin,
